...
Forensics - Consists heavily of file analysis of disk images, regular images, audio, PCAPs, and more to extract hidden data within them. There are also other methods of extracting info that you will learn, including hex editors and metadata commands in Windows/Linux.
...
# TIPS
- Practice at least 1 CTF a week if you can.
...
- I've been doing them for about a little less than a year, and it's been a good journey to track my improvement.
- It generally takes about a year to a year and a half to be really good with consistent practice, so be patient and learn as much as you can!
